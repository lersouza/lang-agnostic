...
class ModelArguments:
    ...
    cache_dir: Optional[str] = field(
        ...
        metadata={
            "help": (
                "Path to directory to store the pretrained models downloaded"
                "from huggingface.co"
            )
        },
    )
    use_fast_tokenizer: bool = field(
        ...
        metadata={
            "help": (
                "Whether to use one of the fast tokenizer (backed by the tokenizers library) "
                "or not."
            )
        },
    )
...
class DataTrainingArguments:
    ...
    context_column: Optional[str] = field(
        ...
        metadata={
            "help": (
                "The name of the column in the datasets containing the contexts "
    ...
    question_column: Optional[str] = field(
        ...
        metadata={
            "help": (
                "The name of the column in the datasets containing the questions "
                " (for question answering)."
            )
        },
    )
    answer_column: Optional[str] = field(
        ...
        metadata={
            "help": (
                "The name of the column in the datasets containing the answers "
                "(for question answering)."
            )
        },
    )
    ...
    val_max_answer_length: Optional[int] = field(
        ...
        metadata={
            "help": (
                ...
                "Will default to `max_answer_length`. "
    ...
    pad_to_max_length: bool = field(
        ...
        metadata={
            "help": (
                "Whether to pad all samples to `max_seq_length`. If False, will pad the samples "
